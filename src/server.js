...
// Shape:
// usersByHash[hash] = { tier, wallets: [{address,label,enabled}], createdAt }
// walletBuysByUser[hash] = [{wallet,address,mint,ts,signature}]
// convergenceByUser[hash] = [{mint,symbol,walletCount,firstTs,lastTs,windowMins,wallets:[{address,label}]}]
