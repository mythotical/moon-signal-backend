...
/**
 * ML-ASSIST style endpoint:
 * Returns probabilities + regime. DOES NOT decide trades.
 *
 * GET /assist/:chain/:pair?alpha=...&rug=...&chg5=...&chg1=...&buys5=...&sells5=...
 */
router.get("/assist/:chain/:pair", (req, res) => {
  ...
  // "pump" probability (0..1) — heuristic + momentum + flow
  ...
  // "rug" probability (0..1) — heuristic + down-momentum + sell pressure
  ...
  res.json({
    ...
    note: "Assistant only — do not auto-buy/sell from this alone."
  });
});
